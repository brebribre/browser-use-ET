...
from browser_use_et.agent.prompts import SystemPrompt
from browser_use_et.agent.views import ActionResult
from browser_use_et.browser.views import BrowserState, TabInfo
from browser_use_et.dom.views import DOMElementNode, DOMTextNode
...
def test_token_overflow_handling_with_real_flow(message_manager: MessageManager, max_tokens):
	...
	for i in range(200):  # Simulate 40 steps of interaction
		...
		from browser_use_et.agent.views import AgentBrain, AgentOutput
